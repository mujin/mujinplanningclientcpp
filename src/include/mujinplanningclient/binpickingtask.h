 ...
 */
#ifndef MUJIN_PLANNINGCLIENT_BINPICKINGTASK_H
#define MUJIN_PLANNINGCLIENT_BINPICKINGTASK_H
...
{
public:
    BinPickingResultResource(PlanningClientPtr controller, const std::string& pk);
